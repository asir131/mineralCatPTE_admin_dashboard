...
export default function Edit_single_blanks() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Header */}
      <button onClick={goBack} className="bg-red-700 text-white px-4 py-3 flex items-center">
