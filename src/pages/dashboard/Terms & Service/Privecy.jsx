...
export default function Privecy() {
    ...
    const fetchTerms = async () => {
      try {
        ...
        const res = await fetchWithAuth(
          `${baseUrl}/privacy-policy/get-privacy`
        );
  ...
  const handleEdit = () => {
    MySwal.fire({
      title: "Are you sure?",
      text: "Do you want to edit the Privecy Policy content?",
      icon: "warning",
      ...
      if (result.isConfirmed) {
        navigate("/settings/privacy/edit");
      }
    });
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-red-800 text-white px-6 py-4">
        <h1 className="text-xl font-medium">Privecy Policy</h1>
      </div>
        ...
        {isLoading && (
          <div className="w-full max-w-4xl mx-auto">
            <div className="bg-[#A85C5C] text-white p-4">
              <h1 className="text-lg font-medium">Privecy Policy</h1>
            </div>
