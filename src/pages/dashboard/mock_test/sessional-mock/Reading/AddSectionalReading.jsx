...
export default function AddSectionalReading() {
 ...
 useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <AllQuestions isMockTest={isMockTest} setQuestions={setQuestions} sectional={sectional} url={"/mock/reading-tests/add"} />
