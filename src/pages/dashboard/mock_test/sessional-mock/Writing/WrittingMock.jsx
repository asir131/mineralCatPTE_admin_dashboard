...
export default function WrittingMockTest() {
  ...
  const { data, isLoading, isError, refetch, error } = useQuery({
    queryKey: ["sectionalMockWrittingTests"],
    queryFn: async () => {
      const response = await fetchWithAuth(
        `${baseUrl}/sectional-mock-test/getAll/writing`
      );
      ...
      <div className="flex justify-between items-center px-8 py-5 bg-gradient-to-r from-[#a91e22] to-[#811b1c]">
        ...
        <div>
          <Button
            ...
            onClick={() => navigate("/mock/writing-tests/add")}
          >
            <Plus className="mr-2" />
            Add Mock Test
          </Button>
